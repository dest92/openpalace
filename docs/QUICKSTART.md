...
I need to add OAuth2 authentication to the login system.
Considering the detected invariants and current architecture,
what's the best approach to integrate this without breaking existing code?
```
...
1. **Learn more**: Read the full [TUTORIAL.md](TUTORIAL.md)
2. **Quick reference**: See [CHEATSHEET.md](CHEATSHEET.md)
3. **Understand concepts**: Check [GLOSSARY.md](GLOSSARY.md)
4. **Real demo**: Watch [DEMO.md](DEMO.md) with actual execution
